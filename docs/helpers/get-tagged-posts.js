...
export const getPostsByTags = () => {
    ...
    const tagBasedPosts = allPostsData.reduce((tagCollection, post) => {
...
export const getPostsByYear = () => {
    ...
    const _yearBasedPosts = Object.entries(yearBasedPosts)
